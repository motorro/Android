package com.motorro.background.ui
...
import com.motorro.background.api.LocalPages
...
fun MainScreen(state: MainScreenViewState, onGesture: (MainScreenGesture) -> Unit, onTerminated: () -> Unit) {
    ...
    when (state) {
        ...
        MainScreenViewState.NeedToEnableNotifications -> NotificationEnableScreen(onGesture)
