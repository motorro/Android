...
class SecurePreferencesFragment : Fragment(), WithViewBinding<FragmentPreferencesBinding> by BindingHost() {

    private val model by viewModels<SecurePreferencesViewModel>()
