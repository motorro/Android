...
class PreferencesPreferencesFragment : Fragment(), WithViewBinding<FragmentPreferencesBinding> by BindingHost() {

    private val model by viewModels<PreferencesPreferencesViewModel>()
