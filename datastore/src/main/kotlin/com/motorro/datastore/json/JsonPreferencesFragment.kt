...
class JsonPreferencesFragment : Fragment(), WithViewBinding<FragmentPreferencesBinding> by BindingHost() {

    private val model by viewModels<JsonPreferencesViewModel>()
