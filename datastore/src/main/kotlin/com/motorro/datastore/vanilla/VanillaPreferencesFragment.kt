...
class VanillaPreferencesFragment : Fragment(), WithViewBinding<FragmentPreferencesBinding> by BindingHost() {

    private val model by viewModels<VanillaPreferencesViewModel>()
