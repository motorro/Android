package com.motorro.statemachine.common.state
 ...
 */
abstract class BaseCoroutineState<G : Any, U: Any> : CoroutineState<G, U>() {
    protected open val tag: String get() = "StateMachine"
    protected open val stateTag: String get() = this::class.simpleName ?: "BaseCoroutineState"
