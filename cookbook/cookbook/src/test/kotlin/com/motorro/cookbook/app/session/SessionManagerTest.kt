...
import com.motorro.cookbook.app.profile
import com.motorro.cookbook.app.session
...
class SessionManagerTest {
    ...
    private inline fun managerTest(crossinline block: suspend TestScope.() -> Unit) = runTest(UnconfinedTestDispatcher()) {
        sessionManager = SessionManager.Impl(sessionStorage, userApi, backgroundScope) {
            println(it)
        }
        block()
    }
